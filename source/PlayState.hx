	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'hog':
				...
				//scorched stage
				sunset = new BGSprite('hog/scorch/sunset', -1700, -400, 1, 0.8);
				sunset.scale.x = 1.5;
				sunset.scale.y = 1.5;
				//sunset.scrollFactor.set(1, 0.8);
				add(sunset);

				mountains = new BGSprite('hog/scorch/mountains', -650, -50, 0.75, 0.75);
				//mountains.scrollFactor.set(0.75, 0.75);
				add(mountains);

				waterfall = new FlxSprite(-1000, 200);
				waterfall.frames = Paths.getSparrowAtlas('hog/scorch/Waterfall', 'when the blast is manual');
				waterfall.animation.addByPrefix('water', 'Waterfall', 12);
				waterfall.animation.play('water');
				waterfall.scrollFactor.set(0.8, 0.8);
				add(waterfall);

				hills = new BGSprite('hog/scorch/Hills', -110, 265, 0.9, 0.9);
				...
				ground = new BGSprite('hog/scorch/ground', -600, 800, 1, 1);
				ground.scale.x = 1.25;
				ground.scale.y = 1.25;
				add(ground);

				stones = new BGSprite('hog/scorch/stones', -600, 690, 1.1, 1);
				//stones.scrollFactor.set(1.1, 1);
				add(stones);
			...
			case 'manual blast':
			{
				switch (curStep)
				{
					...
					case 4672:
						...
						glitchKill(mountains);
						//1

					case 4710:
						camFuckShader.amount = 0.035;
						glitchKill(waterfall);
						//2
