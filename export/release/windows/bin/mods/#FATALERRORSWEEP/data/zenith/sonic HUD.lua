...
function onCreate()
    ...
    makeLuaText('sonicScoreText',getProperty('score'),100,getProperty('sonicScoreSprite.x') + 200,getProperty('sonicScoreSprite.y'))
    setObjectCamera('sonicScoreText','hud')
    scaleObject('sonicScoreText',2.2,2.2)
    setTextFont('sonicScoreText','sonic2.ttf')
    setTextBorder('sonicScoreText',1,'000000')
    setTextAlignment('sonicScoreText','left')
    setProperty('sonicScoreText.antialiasing',false)

    makeLuaText('sonicMissesText',getProperty('songMisses'),100,getProperty('sonicMissesSprite.x') + getProperty('sonicMissesSprite.width'), getProperty('sonicMissesSprite.y'))
    setObjectCamera('sonicMissesText','hud')
    scaleObject('sonicMissesText',2.2,2.2)
    setTextFont('sonicMissesText','sonic2.ttf')
    setTextBorder('sonicMissesText',1,'000000')
    setTextAlignment('sonicMissesText','left')
    setProperty('sonicMissesText.antialiasing',false)

    makeLuaText('sonicTimeText',getSongPosition(),100,getProperty('sonicTimeSprite.x') + getProperty('sonicTimeSprite.width')/1.2, getProperty('sonicTimeSprite.y'))
    setObjectCamera('sonicTimeText','hud')
    scaleObject('sonicTimeText',2.2,2.2)
    setTextFont('sonicTimeText','sonic2.ttf')
    setTextBorder('sonicTimeText',1,'000000')
    setTextAlignment('sonicTimeText','left')
    setProperty('sonicTimeText.antialiasing',false)
end
