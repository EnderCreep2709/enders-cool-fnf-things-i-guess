...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		int monitorCounter;
		::Array< ::String > monitorAnims;
		 ::GlitchShaderB camGlitchShader;
		 ::Fuck camFuckShader;
		 ::openfl::filters::BitmapFilter camGlitchFilter;
		 ::openfl::filters::BitmapFilter camFuckFilter;
		::Array< ::Dynamic> piss;
		...
		::Array< ::String > controlArray;
		 ::StaticShader staticlol;
		 ::StaticShader staticlmao;
		 ::openfl::filters::ShaderFilter staticOverlay;
		 ::DistortGlitchShader glitchThingy;
		 ::openfl::filters::ShaderFilter glitchOverlay;
		Float staticAlpha;
		 ::BGSprite sunset;
		 ::BGSprite mountains;
		 ::flixel::FlxSprite waterfall;
		 ::BGSprite hills;
		 ::flixel::FlxSprite sayo;
		 ::BGSprite plants;
		 ::BGSprite ground;
		 ::BGSprite stones;
		bool wowZoomin;
		bool holyFuckStopZoomin;
		bool pleaseStopZoomin;
		bool ohGodTheZooms;
		...
		::Array< ::Dynamic> glitchShaders;
		void glitchKill( ::flixel::FlxSprite spr,::hx::Null< bool >  dontKill);
		::Dynamic glitchKill_dyn();
