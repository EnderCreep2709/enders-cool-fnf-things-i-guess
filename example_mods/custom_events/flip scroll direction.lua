	...
	if e == "flip scroll direction" then
		...
		for i = 0,7 do
			if isDownscroll then
				...
				doTweenY('hpBar', 'healthBar', screenHeight*0.89,  speed, 'quintOut')
				doTweenY('scoreTxt', 'scoreTxt', screenHeight*0.89+36,  speed, 'quintOut')
				doTweenY('timeTxt', 'timeTxt', 19,  speed, 'quintOut')
				doTweenY('timeBg', 'timeBar', 19+10,  speed, 'quintOut')
				doTweenY('icon1', 'iconP1', screenHeight*0.89-75,  speed, 'quintOut')
				doTweenY('icon2', 'iconP2', screenHeight*0.89-75,  speed, 'quintOut')
			elseif not isDownscroll then
				noteTweenY('gn1'..i, i, 550, speed, 'quintOut')
				doTweenY('hpBar1', 'healthBar', screenHeight*0.11, speed, 'quintOut')
				doTweenY('scoreTxt', 'scoreTxt', screenHeight*0.11+36,  speed, 'quintOut')
				doTweenY('timeTxt1', 'timeTxt', screenHeight-44,  speed, 'quintOut')
				doTweenY('timeBg1', 'timeBar', screenHeight-44+10,  speed, 'quintOut')
				doTweenY('icon11', 'iconP1', screenHeight*0.11-75,  speed, 'quintOut')
				doTweenY('icon21', 'iconP2', screenHeight*0.11-75,  speed, 'quintOut')
			end
		end
