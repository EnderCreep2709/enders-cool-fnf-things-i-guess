...
function onCreate()
	...
	setLuaSpriteScrollFactor('black', 0, 0);
                ...
                makeAnimatedLuaSprite('grab', 'grab', -384, -721);
	...
	makeLuaSprite('fools', 'fools', 0, 0);
	setLuaSpriteScrollFactor('fools', 0, 0);
                setProperty('fools.visible',false);

	addLuaSprite('fools', true);
	setObjectCamera('fools','hud');
...
function onUpdate(elapsed)
    ...
    setProperty('healthBar.y', 12);
    setProperty('iconP1.visible', false);
    setProperty('iconP2.visible', false);

        setProperty('gf.visible',false);
        setScrollFactor('dad', 0.6, 0.6)
...
--end
    ...
    if curBeat == 640 then
        setProperty('fools.visible',true);
    end
